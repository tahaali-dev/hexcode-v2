        ...
        <SectionCont className="px-40 py-40">
          <div className="d-flex align-center justify-between align-start-mob g-md m-col">
            <div className="d-flex flex-column g-start">
              ...
              >
                Brand refresh for a leading dental clinic with trusted,
                high-quality care
              </DyTitleH1>
              ...
              <BtnHolder className="d-flex g-md mt-xl">
                <BtnVar2
                  onClick={() =>
                    window.open("https://www.starbritedental.com/", "_blank")
                  }
                >
                  Visit Site
                </BtnVar2>
          ...
          <Dpara
            ...
            className="mt-lg"
          >
            StarBrite Dental is a trusted dental clinic based in Fremont,
            California, offering comprehensive dental care. From routine
            checkups to cosmetic and emergency procedures. With over two decades
            of service, their clinic is known for patient-first care and a
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Despite being a well-established clinic, StarBrite’s website
              hadn’t kept pace with their growing practice. The site lacked a
              modern interface, mobile responsiveness, and clear user pathways.
              It also failed to convey the clinic’s warm, welcoming ethos and
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              We worked closely with the clinic’s leadership to reimagine the
              website experience from the ground up. One that reflected their
              clinical expertise, approachability, and commitment to patient
              comfort.
            </Dpara>
          </div>
        </SectionCont>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Created a calm, modern visual identity with a palette that felt
              both professional and reassuring. Used real imagery to highlight
              the human side of their care. Happy patients, expert dentists, and
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Built a fully responsive, visually clean website tailored for
              patients of all ages. Simplified navigation to make it easier to
              explore services, meet the team, and book appointments. Introduced
              clear call-to-actions for both new and returning patients.
            </Dpara>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Integrated online appointment booking. Added trust-building
              content like testimonials, certifications, and emergency care
              information.
            </Dpara>
          </div>
       ...
       Results
            ...
            <div className="">
              {testimonials
                .filter(
                  (testimonial) =>
                    testimonial.name === "Dr. Munira Lokhandwala",
                )
                .map((t, index) => (
