      ...
      <DashedContainer>
        <SectionCont className="px-40 py-40">
          <div className="d-flex align-center justify-between align-start-mob g-md m-col">
            <div className="d-flex flex-column g-start">
              ...
              <BtnHolder className="d-flex g-md mt-xl">
                <BtnVar2
                  onClick={() => window.open("https://voltmoney.in/", "_blank")}
                >
                  Visit Site
                </BtnVar2>
                <PrimaryBtn
          ...
          <Dpara
            ...
            className="mt-lg"
          >
            When the Volt Money team first reached out to us at Hexcode, they
            had a bold idea: what if people could get affordable loans simply by
            pledging their mutual funds, without ever having to sell them? The
            catch? Most people had never even heard of this kind of credit. That
            meant building not just a product but also trust, education, and a
            sense of security around an unfamiliar financial tool, all while
          ...
          <Dpara
            ...
            className="mt-lg"
          >
            Over almost two years, we became more than just a design agency for
            Volt. We were partners, working side by side with their team to
            shape everything from their brand identity and app experience to
            marketing and design systems. Our goal was simple: help Volt become
            a trusted, clear, and approachable option for anyone curious about
            borrowing against their investments.
          </Dpara>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Borrowing against mutual funds isn’t something most people know
              about, so right from the start, we had to help users understand
              and feel good about what Volt offered. Trust was everything. That
              meant stripping out jargon, making every process feel seamless,
              and always putting the user’s concerns first. The Volt team was
              rapidly adding features, raising capital, and growing their
              momentum.
            </Dpara>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Every phase of our work with Volt involved close collaboration and
              open feedback. We spent time with their team to understand not
              just the product, but also the users, their doubts, and what would
              make them feel confident. Together, we iterated, tested, and
              refined, always aiming to make a complex idea feel simple and
              approachable.
            </Dpara>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              We kicked things off by uncovering what made Volt special, then
              defined how it should look and sound to the world. The visual
              style needed the right balance: it had to feel modern and
              credible, but never cold or intimidating. We crafted a look that
              was both trustworthy and welcoming.
            </Dpara>
          </div>
      ...
      <DashedContainer>
        <SectionCont className="px-40 py-40 d-flex flex-column g-start">
          ...
          <Dpara
            ...
            className="mt-lg"
          >
            Next, we designed an app that anyone not just finance pros could use
            with confidence. Whether pledging funds, checking on loans, or
            receiving updates, every step was streamlined to feel clear and
            comforting, never overwhelming. We built a reusable component
            library so the Volt team could quickly add new features without
            feeling lost.
          </Dpara>
        </SectionCont>
      </DashedContainer>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              As Volt grew, they needed to keep their product feeling
              consistent, no matter how fast they moved. Our custom design
              system became the single source of truth for every color, button,
              and interaction. It was more than just a rulebook. It acted like a
              kit that empowered both designers and developers to do their best
              work, faster.
            </Dpara>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              We knew first impressions were important, especially in a new
              financial category. So we made sure Volt’s website told their
              story simply and clearly, breaking down the benefits and guiding
              users through the process step by step. Social proof and friendly
              visuals built the trust that new customers needed.
            </Dpara>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              So how did it all turn out? Users loved the app, which earned a{" "}
              <a
                target="_blank"
                className="red-anchor"
                href="https://play.google.com/store/apps/details?id=in.voltmoney&hl=en_IN"
              >
                4.8+ rating
              </a>{" "}
              on the Google Play Store. The website helped drive new signups,
              thanks to its clarity. Most importantly, Volt’s customers felt
              empowered to try something new, backed by a product (and a
              partner) that put their needs first.
            </Dpara>
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Through all the ups, pivots, and launches, we didn’t just keep
              Volt looking sharp. We helped them grow with their users in mind
              ...
              {testimonials
                ...
                .map((t, index) => (
                  <TestimonialCard key={index} className="mt-xl">
                    <HexSectionName
                      title="Testimonial"
                      className="d-flex align-center justify-start g-sm about-img"
                    />
                    <Dpara
                      fontSize="28px"
                      lineHeight="40px"
