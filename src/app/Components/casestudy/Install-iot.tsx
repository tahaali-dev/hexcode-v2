      ...
      <DashedContainer>
        <SectionCont className="px-40 py-40">
          <div className="d-flex align-center justify-between align-start-mob g-md m-col">
            <div className="d-flex flex-column g-start">
              ...
              <BtnHolder className="d-flex g-md mt-xl">
                <BtnVar2
                  onClick={() =>
                    window.open("https://www.install-iot.com/", "_blank")
                  }
                >
                  Visit Site
                </BtnVar2>
          ...
          <Dpara
            ...
            className="mt-lg"
          >
            Install IoT is a specialized IoT installation and maintenance
            service founded by former IoT entrepreneurs Mohammed Khambaty and
            Taher Lokhandwala in early 2024. Based in Houston, Texas, Install
            IoT connects businesses with expert technicians nationwide to handle
            sales demos, device installations, maintenance, and IoT architecture
            across industries including healthcare, retail, and manufacturing.
          </Dpara>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              Installing IoT devices isn't simple. Finding reliable technicians
              for one-off deployments is nearly impossible. As former IoT
              entrepreneurs themselves, the Install IoT founders knew this pain
              intimately.
            </Dpara>
            <Dpara
              fontSize="20px"
              ...
              className="mt-lg"
            >
              They built Install IoT to solve it—connecting businesses with
              vetted technicians nationwide for sales demos, installations, and
              full-scale deployments. But as a startup, they faced a critical
              problem: how do you establish credibility in a $56B market
              dominated by enterprise players?
            </Dpara>
            <Dpara
              fontSize="20px"
              lineHeight="28px"
              ...
              className="mt-lg"
            >
              They needed a brand identity that communicated expertise and trust
              instantly. A website that made their service offering crystal
              clear. And marketing collateral that helped their founders close
              deals.
            </Dpara>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-md"
            >
              We created a clean, modern visual system that balances technical
              sophistication with approachability. The identity works across
              digital and print, making Install IoT feel established and
            ...
            <div>
              ...
              <ul className="mt-xl">
                ...
                <DyLi
                  ...
                  className="mt-md ml-md text-left"
                >
                  Bold color palette for energy, grounded with professional
                  neutrals
                </DyLi>
                <DyLi
                  fontSize={{ base: "20px", md: "20px", sm: "20px" }}
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              With 80% mobile traffic, we prioritized a mobile-first design
              approach while ensuring the desktop experience remained powerful
              and comprehensive.
            </Dpara>
            ...
            <div>
              ...
              <Dpara
                ...
                className="mt-lg"
              >
                The homepage immediately addresses the core problem: "We know
                how difficult it is to send technicians for sales demos, pilot
                installations, and full-scale deployments." This empathetic
                opening, followed by clear service breakdown, quickly
                communicates Install IoT's value proposition.
              </Dpara>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-md"
            >
              A visual grid displays all supported technologies (LoRaWAN,
              Zigbee, Bluetooth, Cellular, GPS, etc.) with icons, making
              technical capabilities immediately scannable.
            </Dpara>
          </div>
            ...
            <div>
              ...
              <ul className="mt-xl">
                <DyLi
                  ...
                  className="mt-md ml-md text-left"
                >
                  Established immediate credibility with IoT companies,
                  appearing as a mature, trustworthy partner rather than a
                  startup.
                </DyLi>
                <DyLi
                  fontSize={{ base: "20px", md: "20px", sm: "20px" }}
                  ...
                  className="mt-md ml-md text-left"
                >
                  The transparent pricing and clear service communication have
                  lowered barriers to inquiry, generating consistent inbound
                  leads.
                </DyLi>
                <DyLi
                  fontSize={{ base: "20px", md: "20px", sm: "20px" }}
                  ...
                  className="mt-md ml-md text-left"
                >
                  The sales deck and collateral have streamlined the sales
                  process, allowing founders to focus on client relationships
                  rather than creating materials from scratch.
                </DyLi>
              </ul>
            </div>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <div>
              {testimonials
                .filter(
                  (testimonial) => testimonial.name === "Mohammed Khambaty",
                )
                .map((t, index) => (
