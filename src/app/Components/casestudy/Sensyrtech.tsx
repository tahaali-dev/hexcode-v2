      ...
      <DashedContainer>
        <SectionCont className="px-40 py-40">
          <div className="d-flex align-center justify-between align-start-mob g-md m-col">
            <div className="d-flex flex-column g-start">
              ...
              <BtnHolder className="d-flex g-md mt-xl">
                <BtnVar2
                  onClick={() =>
                    window.open("https://www.sensyrtech.com/", "_blank")
                  }
                >
                  Visit Site
                </BtnVar2>
          ...
          <Dpara
            ...
            className="mt-lg"
          >
            Asset Tracking is a part of the Sensyrtech cloud suite. They provide
            a unified platform for Industrial IoT. Building customisable
            solutions for managing industrial operations to prevent costly
            downtime, equipment damage, and streamline staff collaboration.
          </Dpara>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              We have used double diamond process. This helped us in building
              solution that will help business and customer goals.
            </Dpara>
          </div>
          ...
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <div>
              ...
              <Dpara
                ...
                className="mt-md"
              >
                We started with getting better understanding of the problem we
                are working on. Below is some goals and objectives:
              </Dpara>
              ...
              <ul className="mt-xl">
                ...
                >
                  Building a tool that will allow customers to see where their
                  assets are throughout their facility.
                </DyLi>
                <DyLi
                  fontSize={{ base: "20px", md: "20px", sm: "20px" }}
                  lineHeight={{ base: "28px", md: "28cpx", sm: "28px" }}
            ...
            <div>
              ...
              <Dpara
                ...
                className="mt-md"
              >
                We interviewed the customers to understand the current scenario
                and got the following insights:
              </Dpara>
              ...
              <ul className="mt-xl">
                ...
                <DyLi
                  ...
                  className="mt-md ml-md text-left"
                >
                  Everything is scattered everywhere (drivers, vehicles, and
                  equipment)
                </DyLi>
              </ul>
            </div>
            ...
            <div>
              ...
              <Dpara
                ...
                className="mt-md"
              >
                This tool will be majorly used by these people for their day to
                day operation in the facility.
              </Dpara>
              ...
              <div>
                ...
                <Dpara
                  ...
                  className="mt-md"
                >
                  We explore products of our competitors and figure out how they
                  are approaching the problem space.
                </Dpara>
              </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-lg"
            >
              We brainstorm on different ideas with the stakeholders. The goal
              is to look at other possibilities and find better solution and not
              commit to the initial ideas comes to mind. We eliminate the ones
              which is not viable or important and deprecate them for v2.
            </Dpara>
          ...
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <div>
              ...
              <Dpara
                ...
                className="mt-md"
              >
                We sketched out the solutions and discussed it with the PMs and
                engineers. This helps us in getting alignment and resolve
                blockers at this stage before diving into the visual design.
              </Dpara>
          ...
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <div>
              ...
              <Dpara
                ...
                className="mt-md"
              >
                Colour palette includes primary, accent and system colours with
                shades of grey and we for the typography, we wanted to use
                something which is simple and have good readability across size
                and weights.
              </Dpara>
            </div>
          </div>
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <Dpara
              ...
              className="mt-md"
            >
              We freeze the solution and move on to the visual designs. The
              challenge was to create usable interfaces for these complex
              problems. Defining the guides early helped us in creating the
              mocks and prototype of the solution and get approval from the
        ...
        <SectionCont className="d-flex flex-column g-start">
          <div className="px-40 py-40 d-flex flex-column g-start">
            ...
            <div>
              {testimonials
                .filter(
                  (testimonial) => testimonial.name === "Taher Lokhandwala",
                )
                .map((t, index) => (
